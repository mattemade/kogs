...
import com.littlekt.graphics.gl.BlendEquationMode
import com.littlekt.graphics.gl.BlendFactor
import com.littlekt.graphics.gl.FaceMode
...
open class SceneGraph<InputType>(
    ...
    override fun touchDragged(screenX: Float, screenY: Float, movementX: Float, movementY: Float, pointer: Pointer): Boolean {
        if (controller.touchDragged(screenX, screenY, movementX, movementY, pointer)) return true
