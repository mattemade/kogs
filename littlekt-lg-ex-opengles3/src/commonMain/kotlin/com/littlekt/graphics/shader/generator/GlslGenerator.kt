package com.littlekt.graphics.shader.generator
...
import com.littlekt.graphics.shader.generator.delegate.*
import com.littlekt.graphics.shader.generator.type.Bool
import com.littlekt.graphics.shader.generator.type.Func
import com.littlekt.graphics.shader.generator.type.GenType
import com.littlekt.graphics.shader.generator.type.Variable
import com.littlekt.graphics.shader.generator.type.mat.Mat2
import com.littlekt.graphics.shader.generator.type.mat.Mat3
...
import com.littlekt.graphics.shader.generator.type.sampler.Sampler2DArray
import com.littlekt.graphics.shader.generator.type.sampler.Sampler2DVarArray
import com.littlekt.graphics.shader.generator.type.sampler.ShadowTexture2D
...
import com.littlekt.graphics.shader.generator.type.func.Void as FuncVoid
...
abstract class GlslGenerator : GlslProvider {
    ...
    fun xpow(v: GLFloat, x: Float) = GLFloat(this, "pow(${v.value}, ${x.str()})")
    ...
    operator fun Set<ShaderParameter>.get(name: String) = first { it.name == name }
}
