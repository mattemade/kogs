...
import com.littlekt.util.datastructure.internal.fill
...
open class FontCache(val pages: Int = 1) {
    ...
    fun setText(
        ...
        letterLimit: Int = text.length,
    ) {
        clear()
        addText(font, text, x, y, scaleX, scaleY, rotation, color, targetWidth, align, wrap, truncate, letterLimit)
    }
    ...
    fun addText(
        ...
        layout.setText(font, text, color, targetWidth, scaleX, scaleY, align, wrap, truncate, letterLimit)
        addToCache(layout, x, y, scaleX, scaleY, rotation, color)
    }
