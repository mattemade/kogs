...
internal open class SingletonBase<T, A>(private val constructor: (A) -> T) {
    ...
    /**
     * Get the instance of the singleton if it exists or else throws an error if it hasn't been created yet.
     */
    val INSTANCE: T get() = instance ?: error("Instance has not been created!")
     ...
     * @param args: Arguments used to construct instance.
     */
    fun getInstanceOrCreate(args: A): T = instance ?: lock(this) {
