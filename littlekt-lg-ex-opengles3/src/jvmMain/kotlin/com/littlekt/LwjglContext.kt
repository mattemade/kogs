...
class LwjglContext(override val configuration: JvmConfiguration) : Context() {
    ...
    override fun start(build: (app: Context) -> ContextListener) = runBlocking {
        ...
        val versionString = GLES30.glGetString(GLES30.GL_VERSION) ?: ""
        val vendorString = GLES30.glGetString(GLES30.GL_VENDOR) ?: ""
        val rendererString = GLES30.glGetString(GLES30.GL_RENDERER) ?: ""
